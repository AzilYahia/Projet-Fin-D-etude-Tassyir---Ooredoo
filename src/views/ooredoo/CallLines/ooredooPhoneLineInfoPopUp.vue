<template>
  <div class="popup" v-show="!isShown">
    <div class="user-infos" >
      ...
      <v-avatar color="#df0327" size="100"  class="user-image">
                    ...
                    </span><span class="text-h3" style="color: white" v-else>
                        ?
                    </span>
      ...
      <div class="name-and-infos" v-if="employee.utilisateur != null">
      ...
      <div class="name-and-infos" v-else>
        <h3 >Not Assigned</h3>
        <div class="infos">
