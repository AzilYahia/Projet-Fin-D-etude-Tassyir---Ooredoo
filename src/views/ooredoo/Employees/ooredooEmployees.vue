<template>
  <div class="whole">
    ...
    <table v-else cellspacing="0" >
      ...
      <tr>
        ...
        <td>
          <wx-employees-ooredoo :employee="oneInstance"/>
        </td>
      </tr>
      </tbody>
      <tfoot>
  ...
  <ooredoo-create-employee-popup :isCreateEmployeePopupShown="!isCreateEmployeePopupShown"  @cancelFunction="()=>{isCreateEmployeePopupShown = !isCreateEmployeePopupShown}" />
...
import ooredooCreateEmployeePopup from "@/views/ooredoo/Employees/ooredooCreateEmployeePopup.vue";
