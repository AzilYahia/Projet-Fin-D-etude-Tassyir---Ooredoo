<template>
  <div class="sala">
    ...
    <EditOoredooEmployeePopup  :employee="selectedEmployee" v-if="selectedEmployee !== null" @cancelFunction="()=>{editEmployeePopupisShown = !editEmployeePopupisShown;}" :isShown="editEmployeePopupisShown" />
...
import EditOoredooEmployeePopup from "@/views/ooredoo/Employees/EditOoredooEmployeePopup.vue"; // import the Popup component
