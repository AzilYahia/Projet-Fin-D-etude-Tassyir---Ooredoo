        ...
        <form @submit.prevent="saveEmployee" style="height: 80%; width: 100%;">
          <div class="fields">
            <div class="form-group" >
              ...
              <input id="name" type="text" v-model="employee.nom" required>
            </div>
            <div class="form-group">
              <label for="other-fields">Etat</label>
              <input id="other-fields" v-model="employee.etat">
            </div>
            <div class="form-group">
              <label for="role">Address</label>
              <input id="role" type="text" v-model="employee.adresse" required>
            </div>
            <div class="form-group">
              <label for="role">Telephone</label>
              <input id="role" type="text" v-model="employee.telephone" required>
            </div>
          </div>
          <div class="buttons">
...
export default {
  ...
  methods:{
    ...
    async saveEmployee() {
      try {
        const patchUrl = `https://pfe.ramzi-issiakhem.com/api/v1/company/client/modify/${this.employee.id_entreprise_client}`;
