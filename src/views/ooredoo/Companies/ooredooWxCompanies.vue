<template>
  <div class="sala">
    ...
    <ooredoo-modify-client-company  :employee="selectedEmployee" v-if="selectedEmployee !== null" @cancelFunction="()=>{editEmployeePopupisShown = !editEmployeePopupisShown;}" :isShown="editEmployeePopupisShown" />

    <ooredoo-client-company-information-popup  :employee="selectedEmployee"
...
import OoredooModifyClientCompany from "@/views/ooredoo/Companies/ooredooModifyClientCompany.vue";
...
async function removeEmployee(employee) {
  try {
    const deleteUrl = `https://pfe.ramzi-issiakhem.com/api/v1/company/client/delete/${employee.id_entreprise_client}`;
