...
export default {
    ...
    methods: {
      ...
      async saveEmployee() {
        try {
          const patchUrl = `https://pfe.ramzi-issiakhem.com/api/v1/user/edit/${this.employee.id_client_user}`;
          const response = await axios.patch(patchUrl, {
            prenom: this.employee.prenom,
            nom: this.employee.nom,
            email: this.employee.email,
            nomUtilisateur: this.employee.nomUtilisateur,
            ...
            motDePasse: this.employee.motDePasse
          });
