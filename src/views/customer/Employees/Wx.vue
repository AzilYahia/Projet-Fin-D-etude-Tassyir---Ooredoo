...
import axios from '@/utils/axiosCustom'; // import the Popup component
...
async function removeEmployee(employee) {
  ...
  const deleteUrl = `https://pfe.ramzi-issiakhem.com/api/v1/user/delete/${employee.id_client_user}`;
